		...
		<div class="page-header-inner ">
			...
			<div class="page-logo logo-white">
				<%-- <a href="index.html"> <img alt=""
					...
					<span class="logo-default">ADDGRO</span>
				</a> --%>
				<a href="#"> <img alt=""
						...
						<ul class="dropdown-menu animated slideInDown">
							...
							<li>
								<ul class="dropdown-menu-list small-slimscroll-style"
									...
									<li><a
										href="${pageContext.request.contextPath }/admin/unit"> <span
											class="photo"><i class="fa fa-balance-scale"></i></span> <!-- <span class="subject"> </span> -->
											<span class="subject"> <span class="from">UNIT</span>
										</span>
									</a></li>

									<li><a href="${pageContext.request.contextPath }/admin/fy">
											<span class="photo"><i class="fa fa-calendar"></i></span> <!-- <span class="subject"> </span> -->
											<span class="subject"> <span class="from">FINANACIAL
													YEAR</span>
										</span>
									</a></li>
									...
									<li><a
										href="${pageContext.request.contextPath }/admin/product">
											<span class="photo"><i class="fa fa-product-hunt"></i></span>
											<!-- <span class="subject"> </span> --> <span class="subject">
												<span class="from">PRODUCT</span>
										</span>
									</a></li>
