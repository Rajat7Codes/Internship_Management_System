...
<body>
	<div class="card" style="width: 100%; height: 100%">
		<img class="card-img-top" src="${pageContext.request.contextPath }/static/img/iceico_letterHead.png" alt="Card image">
		<div class="card-img-overlay" style="padding: 40px; padding-left: 50px; font-family: 'Times New Roman';">
			...
			<div class="text" style="text-align: center">Note: If you have any queries
