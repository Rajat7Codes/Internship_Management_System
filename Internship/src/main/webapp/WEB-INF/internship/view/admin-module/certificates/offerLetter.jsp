...
<body
	...
	<div style="padding: 50px; padding-left:70px;">
		...
		<div>
			Date: ${ currentDate } <br> Name: ${stud.firstName }&nbsp;${stud.middleName }&nbsp;${stud.lastName }
		</div>
		<br>
		<div>
			Dear ${stud.firstName }&nbsp;${stud.middleName }&nbsp;${stud.lastName },
			<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We
			are pleased to offer you Internship for Internship Program at ICEICO
			Technologies Pvt. Ltd. which will commence on Dt.: ${ joiningDate }.
			This is paid internship program of complete ${ duration } program. <br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please
			report to HR (name of supervisor) on Dt.: ${ joiningDate } at 10:00
			am prior to your commencement of internship. There will be interview
			while you come for reporting. According your interview result your
			selection will be confirmed. You will be required to complete
			necessary personal forms Non-Competition and Confidentiality
			Agreement prior to your actual start date. <br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We
