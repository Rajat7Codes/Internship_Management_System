		...
		<div class="sidemenu-container navbar-collapse collapse fixed-menu">
			<div id="remove-scroll">
				<ul class="sidemenu  page-header-fixed" data-keep-expanded="false"
					...
					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/student/application"
						class="nav-link "> <i class="material-icons">account_box</i> <span
							class="title">Application Form</span>
					</a></li>

					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/student/enrollment/application"
						class="nav-link "> <i class="material-icons">account_box</i> <span
							class="title">Enrollment</span>
					</a></li>

					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/student/enquiry"
						class="nav-link nav-toggle"> <i class="material-icons">account_box</i>
							<span class="title">Enquiry</span>
					</a></li>

					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/student/feedback"
						class="nav-link nav-toggle"> <i class="material-icons">account_box</i>
							<span class="title">Feedback</span>
					</a></li>
					<li class="nav-item"><a href="#" class="nav-link nav-toggle">
							<i class="material-icons">assignment</i> <span class="title">Application</span>
							<span class="selected"></span> <span class="arrow open"></span>
					</a>
						<ul class="sub-menu">
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/student/leaving"
								class="nav-link "> <span class="title">Leaving</span>
							</a></li>
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/student/bonafide"
								class="nav-link "> <span class="title">Bonafide</span>
							</a></li>
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/student/character"
								class="nav-link "> <span class="title">Character</span>
							</a></li>
						</ul></li>

					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/student/application/next/new/${user}"
						class="nav-link nav-toggle"> <i class="material-icons">account_box</i>
							<span class="title">Next Application</span>
					</a></li>
