		...
		<div class="col-md-12">
			<div class="card card-topline-darkgreen">
				<div class="card-header  card-head pl-4" id="grad">
					<strong class="card-title text-white">CHARACTER APPLICATION</strong>
					<div class="tools">
				...
				<div class="card-body">
					...
					<form:form modelAttribute="studentCharacterApplication"
						name="studentCharacterApplication"
						id="studentCharacterApplication" method="post"
						action="${pageContext.request.contextPath }/student/character/save">
