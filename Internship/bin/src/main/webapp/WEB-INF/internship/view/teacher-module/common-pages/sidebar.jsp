		...
		<div class="sidemenu-container navbar-collapse collapse fixed-menu">
			<div id="remove-scroll">
				<ul class="sidemenu  page-header-fixed" data-keep-expanded="false"
					...
					<li class="nav-item"><a
						href="${pageContext.request.contextPath }/admin/party/master"
						class="nav-link nav-toggle"> <i class="material-icons">verified_user</i>
							<span class="title">Party Master</span>
					</a></li>


					<li class="nav-item"><a href="#" class="nav-link nav-toggle">
							<i class="material-icons">shopping_cart</i> <span class="title">Orders</span>
							<span class="selected"></span> <span class="arrow open"></span>
					</a>
						<ul class="sub-menu">
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/admin/party/order/summary"
								class="nav-link "> <span class="title">Today<sup>'</sup>s
								</span>
							</a></li>
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/admin/party/order/master"
								class="nav-link "> <span class="title">Master</span>
							</a></li>
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/admin/party/order/all"
								class="nav-link "> <span class="title">List All</span>
							</a></li>
